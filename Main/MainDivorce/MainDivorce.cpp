...
int main()
{
	ifstream file("C:\\Users\\User\\Documents\\MVS\\курсовая\\datasets\\divorce.txt");
	int comma_count = 0;
	vector <line> data;
	vector <line> test;
	...
	if (!file.is_open()) printf("Could not open the file\n");
		...
		if (post == 0) {
			ifstream file1("C:\\Users\\User\\Documents\\MVS\\курсовая\\datasets\\divorce_prune.txt");
		...
		file.close();
		ifstream file("C:\\Users\\User\\Documents\\MVS\\курсовая\\datasets\\divorce_test.txt");
		int correct = 0;
		int incorrect = 0;
		if (!file.is_open()) printf("Could not open the file\n");
		else {
			...
			if (post == 0) {
				...
				ifstream file2("C:\\Users\\User\\Documents\\MVS\\курсовая\\datasets\\divorce_prune.txt");
